(function () {
  ...
  function applyLang(lang) {
    ...
    document
      .getElementById("lang-nl")
      .setAttribute("aria-pressed", String(lang === "nl"));
    document
      .getElementById("lang-en")
      .setAttribute("aria-pressed", String(lang === "en"));
    try {
      localStorage.setItem("neabbs-lang", lang);
    } catch (e) {
      /* private mode */
    }
  }
  var saved = "nl";
  try {
    saved = localStorage.getItem("neabbs-lang") || "nl";
  } catch (e) {
    /* private mode */
  }
  ...
  var bootLines = ["ATDT 020-621984", "CONNECT 1200", ""]
    .concat(LOGO)
    .concat(["", "Heropend na bijna 40 jaar stilte.", ""]);
    ...
    fetch("/api/status")
      ...
      .then(function (s) {
        var line =
          ...
          " bellers online · " +
          s.registered +
          " geregistreerde bellers\n";
        out.textContent += line;
      })
      .catch(function () {
        /* stats offline: hero stays as-is */
      });
  }
